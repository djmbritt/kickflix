//TODO: Proof of concept to load in external functions and keep kick.js clean.

module.export = function(){

  function kickAssQuery (tracker ,kickQuery, pageNumber, cb) {
    query = {
